...
*Para elegir los parámetros, recordamos que la media de la distribución gamma inversa es $\mu=\frac{\beta}{\alpha+1}$*

```{r}
n = 5000
alpha = 100
beta = sd(x)^2 * alpha + sd(x)
...
*tiene mejores resultados el bootstrap paramétrico, probablemente la información que metimos al suponer distribuciones no sea la más adecuada*
