...
- **Los estados que votan por Obama No son muy liberales, tal vez más de centro**
...
- **y con los parámetros propuestos en el ejercicio(**$Beta(8,160)$**), el promedio se acerca al valor de máxima verosimilitud**
...
- **La media es similar al valor de máxima verosimilitud para la población total**
...
##### Estados de Idaho y Virginia:
  
```{r}

#################### Sara
results %>% filter(state == 'idaho' | state == 'virginia') %>%   kable("html") %>%
  kable_styling("striped", full_width = FALSE)
idaho_n = 140
idaho_y = 14
virginia_n = 896
