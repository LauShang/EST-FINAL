...
*Nos interesa probar la hipótesis de que la proporción del condado y de el resto del estado son distintas*
...
$P(x,\pi|n)=n!\Pi_{i=1}^{m}\frac{\pi_i^{x_i}}{x_i!}$

*Por lo que podemos calcular la log-verosimilitud tenemos:*

$\text{log}L(\pi)=\text{log}n!\Pi_{i=1}^{m}\frac{\pi_i^{x_i}}{x_i!}=\text{log}n!+\sum_{i=1}^{m}x_i\text{log}\pi_i-\sum_{i=1}^{m}\text{log}x_i!$
